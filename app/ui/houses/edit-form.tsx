...
import { updateHouse, HouseState } from "@/app/lib/actions";
import { HouseForm, StreetField, BlockField, RTField } from "@/app/lib/definitions";
...
export default function EditHouseForm({ house, streets, blocks, rt }: { house: HouseForm, streets: StreetField[], blocks: BlockField[], rt: RTField[] }) {
  const initialState: HouseState = { message: null, errors: {} };
  const updateHouseWithId = updateHouse.bind(null, house.id)
  const [state, formAction] = useActionState(updateHouseWithId, initialState);
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                name="owner"
                type="text"
                defaultValue={house.house_owner}
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                name="tenant"
                type="text"
                defaultValue={house.house_tenants}
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="false"
                  defaultChecked={house.occupied === false}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="true"
                  defaultChecked={house.occupied === true}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="ditempati"
